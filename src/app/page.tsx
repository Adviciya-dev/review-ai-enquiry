...
export default function Home() {
  ...
  const mutation = useMutation({
    mutationFn: async (formData: FormData) => {
      const response = await fetch("https://moc5o26tkyp5ichgmskq5uoqwu0pscbk.lambda-url.ap-south-1.on.aws/leads/public-lead", {
        method: "POST",
        body: formData,
      });
  ...
  return (
    <main className="flex flex-col min-h-screen bg-gray-50">
      {/* Toaster - Add this once at the top level */}
      <Toaster />
