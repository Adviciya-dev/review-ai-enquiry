...
const FormInput: React.FC<Props> = ({
  ...
  return (
    <div className="flex flex-col">
      <label className="block text-medium font-medium text-[#646060] mb-1">
        {label}
      </label>
      ...
      {type === "file" ? (
        <div className="relative">
          ...
          <div
            ...
            className={`flex items-center justify-between border rounded-md px-3 py-2 h-[42px] bg-white cursor-pointer hover:border-gray-400 transition ${
